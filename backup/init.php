...
$site_name = 'The Sneaker Savant'; 
$email_def = 'testing.slinfy@gmail.com';
$email_merchant = 'waliaw_1309867236_biz@gmail.com';

//$sandbox_env = '1'; // Sandbox environment
define('EMAIL_ADD', 'thesneakersavant@gmail.com'); // define any notification email
define('PAYPAL_EMAIL_ADD', 'thesneakersavant@gmail.com'); // facilitator email which will receive payments change this email to a live paypal account id when the site goes live
